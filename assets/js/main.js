...
$(document).ready(function () {
    $( window ).resize();
    if($("#showcase").length){
        var box1 = document.getElementById('showcase');
        var startx = 0;
        var dist = 0;
        var dragpoint = 0;
        ...
        box1.addEventListener('touchmove', function(e){
            ...
            var dragpoint = dist;
            changeshowontouch(dragpoint);
        }, false)
        box1.addEventListener('touchend', function(e){

        }, false)
        function changeshowontouch(dragpoint){
            if($('#showcase').hasClass('touchscroll')){

            }
            else{
                $('#showcase').addClass('touchscroll');
                setTimeout(function() { $('#showcase').removeClass('touchscroll'); }, 500);
                if(dragpoint < 0){
                            showcasechange(2);
                        }
                        else if(dragpoint > 0){
    ...
    if($("#showcase").length){
        var box1 = document.getElementById('homenews');
        var startx = 0;
        var dist = 0;
        var dragpoint = 0;
        box1.addEventListener('touchstart', function(e){
        ...
        function changeshowontouch(dragpoint){
            if($('#homenews').hasClass('touchscroll')){

            }
            else{
                $('#homenews').addClass('touchscroll');
                setTimeout(function() { $('#homenews').removeClass('touchscroll'); }, 500);
                if(dragpoint < 0){
                            newschangenext(1);
                        }
                        else if(dragpoint > 0){
